...
<ul>
    ...
    <li class="text-white font-bold">
        <a href="students.html" class="py-2 px-2 rounded transition-all duration-300-ease-in-out hover:text-custom-purplo hover:bg-white flex items-center align-middle">
    ...
    <li class="text-white font-bold">
        <a href="eventslist.html" class="py-2 px-2 rounded transition-all duration-300-ease-in-out hover:text-custom-purplo hover:bg-white flex items-center align-middle">
    ...
    <li class="text-white font-bold">
        <a href="#" class="py-2 px-2 rounded transition-all duration-300-ease-in-out hover:text-custom-purplo hover:bg-white flex items-center align-middle">
