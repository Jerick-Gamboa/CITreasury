...
<ul>
    ...
    <li class="text-white font-bold">
        <a href="accountprivileges.php" class="py-2 px-2 rounded transition-all duration-300-ease-in-out hover:text-custom-purplo hover:bg-white flex items-center align-middle">
            <svg id="mdi-account-cog-outline" class="w-6 h-6 mr-2 fill-current" viewBox="0 0 24 24">
